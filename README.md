...
Global Supply Chain & Trade Route Analysis
Global Supply Chain and Trade Route data analysis project: used pivot tables in Excel to analyze and visualize supply chain data.
...
o Atlantic and Commodity are mainly affected by port congestion.
o Intra-Asia and Pacific are affected by both port congestion and severe weather.
o Suez is affected entirely by geopolitical conflict.
...
o	Shipping_Cost_Per_Kg: Cost per kilogram for each shipment, calculated to assess cost efficiency.
o	OnTime_Flag: Binary flag indicating whether a shipment was delivered on time (1 = on time, 0 = late).
o	Delay_Flag: Binary flag marking delayed shipments (1 = delayed, 0 = on time).
o	LeadTime_Variance: Difference in days between planned and actual delivery, showing early or late arrivals.
...
•	Tools: Microsoft Excel for feature engineering, analysis, and visualization
How to Run:
1.	Open the Excel workbook SupplyChainAnalysis.xlsx.
